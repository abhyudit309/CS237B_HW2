...
def build_model():
    ...
    p_class = tf.keras.layers.Dense(32, name='p_class', activation='softmax')(base_model_output)
...
def build_baseline_model():
    ...
    base_model_output = base_model(img_input)
    a_pred = tf.keras.layers.Dense(1, name='a_pred')(base_model_output)
